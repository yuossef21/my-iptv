...
// تمرير الصور عبر البروكسي لحل Mixed Content (http → https)
...
export class XtreamAPI {
  ...
  // رابط البث دائماً عبر البروكسي (حل Mixed Content)
